...
export function hasNativeSpeechRecognition(env = globalThis) {
  return Boolean(getSpeechRecognitionCtorFromEnv(env));
}

export function isSpeechRecognitionSupportedInContext(env = globalThis) {
  return hasNativeSpeechRecognition(env) && env?.isSecureContext !== false;
}

export function isSpeechRecognitionSupported() {
  return isSpeechRecognitionSupportedInContext(globalThis);
}
